...
public class ShopVisitingScenariosKeywords{
	...
	/***********************************************************
	 VISIT SHOPS FROM SLIDER E.G. OUT OF ROUTE, RED FLAG SHOPS ETC
	 ***********************************************************/
	@Keyword
	...
	@Keyword
	def visitShopWithDataVerification(){TouchAction touchaction = new TouchAction(ProjectConstants.DRIVER)
