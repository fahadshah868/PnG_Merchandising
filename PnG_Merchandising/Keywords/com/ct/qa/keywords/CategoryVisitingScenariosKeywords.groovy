...
public class CategoryVisitingScenariosKeywords{
	...
	def visitShopCategoriesWithDataVerification(){
		...
		touchaction.press(0, 220).waitAction(Duration.ofMillis(600)).moveTo(0, 200).release().perform()
		Thread.sleep(1000)
		while(true){
			...
			if(lastitemnamebeforeswipe.equalsIgnoreCase(lastitemnameafterswipe)){
				...
				visitShopCategoriesWithDataVerification(lastitemafterswipe)
			}
			touchaction.press(0, 220).waitAction(Duration.ofMillis(600)).moveTo(0, 200).release().perform()
			Thread.sleep(1000)
			while(true){
				startpoint = ProjectConstants.DRIVER.findElementByXPath("//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.ListView[1]/android.widget.LinearLayout[5]")
				endpoint = ProjectConstants.DRIVER.findElementByXPath("//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.ListView[1]/android.widget.LinearLayout[4]")
				touchaction.press(startpoint).waitAction(Duration.ofMillis(600)).moveTo(endpoint).release().perform()
				Thread.sleep(1000)
				index = ProjectConstants.DRIVER.findElementsByXPath("//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.ListView[1]/*").size()
				index = index - 1
		...
		index = ProjectConstants.DRIVER.findElementsByXPath("//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.ListView[1]/*").size()
		MobileElement lastitem = ProjectConstants.DRIVER.findElementByXPath("//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.ListView[1]/android.widget.LinearLayout["+index+"]/android.widget.TextView[1]")
		visitShopCategoriesWithDataVerification(lastitem)
	}
	...
	def visitShopCategoriesWithOverwriteScenarios(){
		...
		while(true){
			...
			if(lastitemnamebeforeswipe.equalsIgnoreCase(lastitemnameafterswipe)){
				...
				lastvisitedcategory = lastitemnameafterswipe
				visitShopCategoriesWithOverwriteScenarios(lastitemafterswipe)
			}
			touchaction.press(0, 220).waitAction(Duration.ofMillis(600)).moveTo(0, 200).release().perform()
			Thread.sleep(1000)
			while(true){
		...
		index = ProjectConstants.DRIVER.findElementsByXPath("//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.ListView[1]/*").size()
		MobileElement lastitem = ProjectConstants.DRIVER.findElementByXPath("//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.widget.ListView[1]/android.widget.LinearLayout["+index+"]/android.widget.TextView[1]")
		visitShopCategoriesWithOverwriteScenarios(lastitem)
	}
