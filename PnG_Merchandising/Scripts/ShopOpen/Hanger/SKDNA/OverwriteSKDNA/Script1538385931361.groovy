...
CustomKeywords.'qa.keywords.HangerKeywords.selectHangerRemark'('ShopKeeper did not allow')
...
Mobile.tap(findTestObject('ShopOpen/HotSpot/ShopKeeperDidnotAllow/CategoryRemarks_Others', [('package') : ProjectConstants.PACKAGENAME]), 
    0)
