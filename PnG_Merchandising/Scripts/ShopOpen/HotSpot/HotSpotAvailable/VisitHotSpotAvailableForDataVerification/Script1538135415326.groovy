...
CustomKeywords.'qa.keywords.HotSpotKeywords.selectHotSpotRemark'('Hotspot Available')
...
CustomKeywords.'qa.keywords.HotSpotKeywords.visitHotSpotTypeForDataVerification'()
...
CustomKeywords.'qa.keywords.HotSpotKeywords.visitHotSpotProductCategories'(1)
...
CustomKeywords.'qa.keywords.HotSpotKeywords.enterUtilization'(1)
