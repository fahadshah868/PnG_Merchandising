...
Mobile.tap(findTestObject('ShopOpen/RemainingMainCategories/AdditionalInfo/Questions_SubmitButton'), 0)

Mobile.verifyElementText(findTestObject('ShopOpen/RemainingMainCategories/AdditionalInfo/Validate_UtilizationPopupScreen'), 
    'Utilization')

Mobile.setText(findTestObject('ShopOpen/RemainingMainCategories/AdditionalInfo/Utilization_EditTextField'), '100', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('ShopOpen/RemainingMainCategories/AdditionalInfo/Utilization_PopupSubmitButton'), 0)
