...
Mobile.tap(findTestObject('ShopOpen/RemainingMainCategories/PrimaryDisplay/ShopKeeperDidnotAllow/CategoryRemark_Return', 
        [('package') : ProjectConstants.PACKAGENAME]), 0)
...
Mobile.tap(findTestObject('ShopOpen/RemainingMainCategories/PrimaryDisplay/BackButton', [('package') : ProjectConstants.PACKAGENAME]), 
    0)
