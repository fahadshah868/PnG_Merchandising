...
Mobile.tap(findTestObject('ShopOpen/RemainingMainCategories/PrimaryDisplay/ShopKeeperDidnotAllow/CategoryRemark_Return', [('package') : ProjectConstants.PACKAGENAME]), 
    0)
