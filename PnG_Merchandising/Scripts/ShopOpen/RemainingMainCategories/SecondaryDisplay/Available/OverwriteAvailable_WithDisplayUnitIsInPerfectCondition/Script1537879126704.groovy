...
CustomKeywords.'com.ct.qa.keywords.RemainingMainCategoriesRemarksKeywords.selectSecondaryDisplay_AvailableRemark'('Display Unit is in perfect condition')
...
Mobile.setText(findTestObject('ShopOpen/RemainingMainCategories/SecondaryDisplay/Available/Utilization_EditField', [('package') : ProjectConstants.PACKAGENAME]), '100', 
    0)
