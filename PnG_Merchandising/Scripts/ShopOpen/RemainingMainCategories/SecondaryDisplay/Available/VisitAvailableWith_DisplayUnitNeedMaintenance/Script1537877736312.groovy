...
Mobile.verifyElementText(findTestObject('ShopOpen/RemainingMainCategories/SecondaryDisplay/Available/Validate_DUNM_CategoryRemarksScreen', [('package') : ProjectConstants.PACKAGENAME]), 
    'CATEGORY REMARKS')

Mobile.tap(findTestObject('ShopOpen/RemainingMainCategories/SecondaryDisplay/Available/DUNM_CategoryRemark_BrokenHeader', [('package') : ProjectConstants.PACKAGENAME]), 
    0)

Mobile.tap(findTestObject('ShopOpen/RemainingMainCategories/SecondaryDisplay/Available/DUNM_CategoryRemarks_BackButton', [('package') : ProjectConstants.PACKAGENAME]), 
    0)
