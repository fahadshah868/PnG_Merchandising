...
MobileBuiltInKeywords.verifyElementExist(findTestObject('ShopActionsScreenElements/ShopPermanentlyClosed'), 0)

MobileBuiltInKeywords.delay(1)

MobileBuiltInKeywords.tap(findTestObject('ShopActionsScreenElements/ShopPermanentlyClosed'), 0)
