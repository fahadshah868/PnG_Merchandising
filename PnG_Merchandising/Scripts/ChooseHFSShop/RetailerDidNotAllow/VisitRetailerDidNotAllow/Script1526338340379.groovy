...
MobileBuiltInKeywords.verifyElementExist(findTestObject('ShopActionsScreenElements/RetailerDidNotAllow'), 0)

MobileBuiltInKeywords.delay(1)

MobileBuiltInKeywords.tap(findTestObject('ShopActionsScreenElements/RetailerDidNotAllow'), 0)
...
MobileBuiltInKeywords.verifyElementText(findTestObject('ShopActionsScreenElements/Validate_ShopRemarksScreen'), 'SHOP REMARKS')

MobileBuiltInKeywords.delay(1)

MobileBuiltInKeywords.tap(findTestObject('ShopActionsScreenElements/ShopRemarks_Others'), 0)

MobileBuiltInKeywords.delay(1)

MobileBuiltInKeywords.tap(findTestObject('ShopActionsScreenElements/ShopRemarks_BackButton'), 0)
