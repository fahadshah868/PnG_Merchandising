...
MobileBuiltInKeywords.verifyElementExist(findTestObject('ShopActionsScreenElements/ShopToBeRemoved'), 0)

MobileBuiltInKeywords.delay(1)

MobileBuiltInKeywords.tap(findTestObject('ShopActionsScreenElements/ShopToBeRemoved'), 0)
