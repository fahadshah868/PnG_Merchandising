...
MobileBuiltInKeywords.verifyElementExist(findTestObject('ShopActionsScreenElements/ShopNotFound'), 0)

MobileBuiltInKeywords.delay(1)

MobileBuiltInKeywords.tap(findTestObject('ShopActionsScreenElements/ShopNotFound'), 0)
